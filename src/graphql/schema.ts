...
#		updateBranch(companyId: String!, name: String, location: LocationInput): Branch!
#		addEmployee(companyId: String!, firstName: String!, lastName: String!, email: Email!): Employee!
#		updateEmployee(companyId: String!, firstName: String, lastName: String, email: Email): Employee!
	}
